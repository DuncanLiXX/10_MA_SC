...
#define SHARED_MEM_MI_STATUS_SYNC_CAL_ERR (SHARED_MEM_MI_STATUS_BASE + 0x58)            //同步轴 同步校准偏差过大
...
public:
    ...
    bool ReadPhyAxisCurFedBckPos(double *pos_fb, double *pos_intp,double *speed,double *torque,double *angle, uint8_t count);    //读取物理轴位置、速度、力矩
