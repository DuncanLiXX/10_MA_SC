...
struct FRegBits{
	...
	uint8_t :8;
	//F70
    uint8_t PSW1:8;   // 位置检测  min <= pos <= max 信号为1
	//F71
    uint8_t PSW2:8;
	//F72
	uint8_t OUT0:1;
	...
	uint8_t :5;
    uint8_t ELIMI1 :1;  // F216.6  木工 工位1除尘
    uint8_t ELIMI2 :1;  // F216.7  工位2除尘
...
struct GRegBits{
    ...
    uint8_t KEY1:1;     //程序锁住信号1     G46.3
    uint8_t KEY2:1;     //程序锁住信号2     G46.4
    uint8_t KEY3:1;     //程序锁住信号3     G46.5
    uint8_t KEY4:1;     //程序锁住信号4     G46.6
    uint8_t :1;
	//G47
	uint8_t :8;
	//G48
